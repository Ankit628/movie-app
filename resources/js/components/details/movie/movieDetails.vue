                        ...
                        <div class="owl-movie-similar owl-carousel owl-theme">
                            <div class="owl-carousel-item" v-bind:key="similar.key" v-for="similar in similars">
                                <div class="item bg-dark">
                                    <router-link v-bind:to="{ name: 'movie-details', params: { id: similar.id } }" class="text-decoration-none">
                                        <div class="flip">
                                            <div class="front">
                                                <img class="d-block w-100" v-bind:src="'https://image.tmdb.org/t/p/w342'+similar.poster_path" v-bind:alt="similar.title">
